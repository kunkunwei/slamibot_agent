...
3. ⏳ 仍在 701 的大件（证据不足或超范围，未删）：`docker_ws_backup` 8.1G、`kn_nav_backup` 165M、`container-fixes` 176M、`scout-nav-product-build` 1.4G、`voice-image-build` 341M、`*.bag` 1.1G；备份清理两批已释放约 3.1G。
